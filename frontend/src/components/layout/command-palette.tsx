      ...
      >
        <Command label="Command palette" className="flex flex-col">
          ...
          <Command.List className="max-h-96 overflow-y-auto scrollbar-thin p-2">
            ...
            <Command.Group
              heading="Screens"
              className="px-1 py-1 text-[11px] font-semibold uppercase tracking-wide text-teal-400"
            >
              <Command.Item
                onSelect={() => go("/")}
            ...
            {payload && payload.transformer_summary.length > 0 && (
              <Command.Group
                ...
                className="mt-2 px-1 py-1 text-[11px] font-semibold uppercase tracking-wide text-teal-400"
              >
                {payload.transformer_summary.map((t) => (
                  <Command.Item
                    ...
                    onSelect={() =>
                      go(`/transformer/${encodeURIComponent(t.transformer_id)}`)
                    }
                  ...
                  >
                    ...
                    <StatusBadge status={statusFromSummary(t)} />
                  </Command.Item>
                ))}
              </Command.Group>
            )}
