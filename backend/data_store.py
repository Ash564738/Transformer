...
def _resolve_status(
    ...
    # --------------------------------------------------------
    # Preferred authoritative status.
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # Fallback only for old payloads.
    # Score is 0-100 in the new revision.
    # --------------------------------------------------------
...
def save_payload_to_db(
    ...
    logger.info(
        "Saving current DGA payload to SQLite."
    )
    ...
    try:
        ...
        for item in payload.get(
            ...
            record = {
                ...
                "latest_sample_day": item.get(
                    "latest_sample_day"
                ),
                "latest_score": item.get(
                    "latest_score"
                ),
                ...
                "diagnostic_confidence": item.get(
                    "diagnostic_confidence",
                    breakdown.get(
                        "diagnostic_confidence"
                    ),
